...
exports.embedChunks = functions
    ...
    const { texts, provider = 'together.ai', model = 'BAAI/bge-base-en-v1.5-vllm' } = data;
    ...
    try {
        ...
        if (isEmulator) {
            console.log('🔍 LLM Request:', JSON.stringify({
                ...
                url: llmApiUrl,
                method: 'POST',
                headers: Object.assign({ 'Authorization': `Bearer ${llmKey.substring(0, 10)}...`, 'Content-Type': 'application/json' }, (actualLlmProvider === 'openrouter.ai' && {
